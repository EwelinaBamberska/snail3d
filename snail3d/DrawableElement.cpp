...
void DrawableElement::drawTextured(double rColor, double gColor, double bColor) {
	...
	//glUniform4f(sp->u("color"), 1, 0.8, 0, 1); // kolor œwiat³a od rozb³ysku
...
void DrawableElement::drawCommon() {
	...
	glUniform4f(sp->u("lp"), 0, 10, -6, 0.8); //Wspó³rzêdne Ÿród³a œwiat³a zwyk³ego
	glUniform4f(sp->u("lp2"), 0, 0, 1, 1); //Wspó³rzêdne Ÿród³a œwiat³a rozb³ysku
